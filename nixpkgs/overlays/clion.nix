...
let
  mkJetBrainsProduct = self.callPackage <nixpkgs/pkgs/applications/editors/jetbrains/common.nix>{};
  jdk = super.pkgs.jetbrains.jdk;
  stdenv = super.stdenv;
  cmake = super.pkgs.cmake;
  ncurses = super.pkgs.ncurses;
  lib = super.lib;
  libxml2 = super.pkgs.libxml2;
  zlib = super.pkgs.zlib;
  python3 = super.pkgs.python3;
  fetchurl = super.fetchurl;
  # Sorted alphabetically

  buildClion = { name, version, src, license, description, wmClass, ... }:
    super.lib.overrideDerivation (mkJetBrainsProduct rec {
...

{
  ...
  clion = buildClion rec {
    ...
    src = fetchurl {
      ...
      sha256 = "6453a526fc832b3493338d5c53d976022daa6d20fb2c7e2012b440f1a8e7d313"; /* updated by script */
    };
