...
let
  stdenv = super.stdenv;
  buildJdk = super.pkgs.jdk;
  fetchurl = super.fetchurl;
  writeCBin = super.writeCBin;
  lib = super.lib;
  bash = super.bash;
  runCommand = super.runCommand;
  makeWrapper = super.makeWrapper;
  callPackage = super.callPackage;
  coreutils = super.coreutils;
  findutils = super.findutils;
  gawk = super.gawk;
  gnugrep = super.gnugrep;
  gnutar = super.gnutar;
  gnused = super.gnused;
  gzip = super.gzip;
  which = super.which;
  ...
  runJdk = super.pkgs.jdk;
  skydocArchive = "2d9566b21fbe405acf5f7bf77eda30df72a4744c";
  srcDeps = [
    (super.fetchurl {
  ...
  (super.fetchurl {
        url = "https://mirror.bazel.build/github.com/bazelbuild/skydoc/archive/${skydocArchive}.tar.gz";
  ...
  (super.fetchurl {
    ...
    sha256 = "165q9d3zvcwhhfn0yi8k34k528cdwqmd6kgcgnnlmvwjsm8cws6q";
  })

  (super.fetchurl {
    url = " https://github.com/bazelbuild/rules_nodejs/archive/0.16.2.zip";
    sha256 = "1q1f703dkqk5dk0xw3br3rwmzn7kbgib209ar37wpmvjx85bnwlv";
  })

  (super.fetchurl {
    url = "https://github.com/bazelbuild/bazel-skylib/archive/f83cb8dd6f5658bc574ccd873e25197055265d1c.tar.gz";
    sha256 = "0llvg7h272ydzj5fyi5lh4gnv0nsb16qwp8841iskz0f4g51apds";
  })

  (super.fetchurl {
    url = "https://mirror.bazel.build/bazel_java_tools/java_tools_javac10_linux-x86_64-v1.0.zip";
    sha256 = "1ipwrpqlj6qdjgm499miy9mbsqb29nbfxhfn981674g07njm5f9y";
  })
  ];
...
in
{
  bazel-latest = stdenv.mkDerivation rec {
...
#   name = "bazel-latest";
  ...
  buildPhase = ''
    ...
    # echo "\n\n${distDir}/skydoc\n\n"
    export EXTRA_BAZEL_ARGS="--distdir ${distDir}"
